            ...
            <div className="lg:mx-32 mx-6">
              <Row className="lg:pt-24">
                <Col lg={9} xs={12} className="pt-28 lg:mt-0 mt-16">
                  <h1 className="text-white text-nowrap venera-500 font-medium lg:text-[44px] text-[30px]" aria-label="Olá, sou Micael Muniz">
                ...
                <Col lg={3} xs={12}>
                  <video className="transform -rotate-45 w-[6rem] mr-2 lg:flex hidden" aria-hidden="true" autoPlay loop muted
                    ...
                    <source src="https://res.cloudinary.com/dtewu315j/video/upload/f_auto:video,q_auto/lava_prop_2" type="video/webm"/>
                  </video>
                  <video className="transform lg:-ms-10 lg:-mt-10 m-[auto] lg:w-[18rem] w-[12rem] lg:my-0 mt-20" aria-hidden="true" autoPlay loop muted
                    ...
                    <source src="https://res.cloudinary.com/dtewu315j/video/upload/f_auto:video,q_auto/lava_prop_4" type="video/webm"/>
                  </video>
                </Col>
              </Row>
            </div>
            ...
            <Fade triggerOnce delay={100}>
              <div className="lg:mx-32 mx-6">
                <Row className="lg:pt-32 pt-10 ">
                  <h2 className="text-fuchsia-500 venera-500 text-xl font-bold lg:-mb-10 mb-4">Um pequeno resumo...</h2>
                  <Col lg={{span: 6, order: 1}} xs={{span: 12, order: 2}}>
                    <div className="mb-4">
                      <video className="lg:ms-24 ms-36 lg:mt-10 mt-5 transform rotate-[260deg] lg:w-[12rem] w-[8rem]" aria-hidden="true" autoPlay loop muted
                        ...
                        <source src="https://res.cloudinary.com/dtewu315j/video/upload/f_auto:video,q_auto/lava_prop_1" type="video/webm"/>
                      </video>
                      <video className="lg:ms-3 ms-16 lg:-mt-80 -mt-56 transform rotate-[75deg] lg:w-[12rem] w-[8rem]" aria-hidden="true" autoPlay loop muted
                        ...
                        <source src="https://res.cloudinary.com/dtewu315j/video/upload/f_auto:video,q_auto/lava_prop_3" type="video/webm"/>
                      </video>
                    </div>
                  </Col>
            ...
            <Fade triggerOnce delay={100}>
              ...
              <div className="lg:mx-32 mx-6">
                <Row className="pt-24">
                  ...
                  <p className="text-white poppins mt-3 tracking-wider">Minha experiência em projetos pessoais, acadêmicos e de freelancer.</p>
                </Row>
                ...
                <Row className="lg:pt-24 pt-5 pb-5">
                  <Col lg={6} xs={12}>
                    <Row className="flex-col justify-between relative h-full">
                      <h2 className="poppins text-3xl text-fuchsia-500 font-bold tracking-wider lg:mb-0 mb-16">Entre em contato</h2>
                      <div>
                        ...
                        <a href="tel:+551140402024" className="inline-block" aria-label="Ligar para">
                          <p className="poppins text-white text-xl tracking-wider m-0">(11) 4040-2024</p>
                        </a>
                      </div>
                  ...
                  <Col lg={6} xs={12}>
                    <div className="flex justify-center">
                      <video className="lg:w-[80%] w-[70%]" aria-hidden="true" autoPlay loop muted
                        ...
                        <source src="https://res.cloudinary.com/dtewu315j/video/upload/f_auto:video,q_auto/lava_prop_6" type="video/webm"/>
                      </video>
                    </div>
                  </Col>
                </Row>
