                ...
                <Col lg={6} xs={12}>
                  <Row className="flex-col justify-between relative h-full">
                    ...
                    <div>
                      ...
                      <a href="mailto:contato@micaelmuniz.com" aria-label="Enviar um e-mail para">
                        <p className="tt-interfaces text-white text-xl tracking-wider">contato@micaelmuniz.com</p>
                      </a>

                      <h3 className="lastica text-white text-xl mb-2 mt-5">TELEFONE</h3>
                      <a href="tel:+551140402024" aria-label="Ligar para">
                        <p className="tt-interfaces text-white text-xl tracking-wider">(11) 4040-2024</p>
                      </a>
                    </div>
