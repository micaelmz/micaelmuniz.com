...
function App() {
  return (
      <>
          ...
          <GradientSection index={0} id="home" height="h-[100vh]">
            <div className="lg:mx-32 mx-6">
              <Row className="h-screen">
                <Col lg={9} xs={12} className="lg:my-auto mt-32">
                ...
                <Col lg={3} xs={12} className="lg:my-auto -mt-32">
        ...
        <main>
          <GradientSection index={1} id="about" height="min-h-screen">
            <Fade triggerOnce delay={100}>
              <div className="lg:mx-32 mx-6">
                <Row className="min-h-screen">
                  <Col lg={{ span: 6, order: 1 }} xs={{ span: 12, order: 2 }} className="lg:my-auto my-[0]">
                    <h2 className="text-fuchsia-500 venera-500 -mt-20 mb-20 text-xl font-bold lg:block hidden">
                      Um pequeno resumo...
                    </h2>
                    <div>
                      <video
                  ...
                  <Col lg={{ span: 6, order: 2 }} xs={{ span: 12, order: 1 }} className="my-auto">
                    <h2 className="text-fuchsia-500 venera-500 -mt-7 mb-7 text-xl font-bold lg:hidden block">
                      Um pequeno resumo...
                    </h2>
          ...
          <GradientSection index={2} id="projects" height="min-h-screen">
            <Fade triggerOnce delay={100}>
              <div className="flex lg:my-0 -mt-20 mb-20">
                <hr className="w-2/3 mx-auto text-white"></hr>
              </div>

              <div className="lg:mx-32 flex mx-6 min-h-screen">
        ...
        <footer>
          <GradientSection index={3} id="contact" height="h-[100]">
            <Fade triggerOnce delay={100}>
              <div className="lg:mx-32 mx-6 min-h-screen">
                <Row className="flex align-items-center lg:pt-0 pt-10 justify-content-center min-h-screen">
                  <Col lg={6} xs={12}>
